...
/**
 * Error boundary for the Evaluations segment. Turns an opaque white-screen
 * "server-side exception" (e.g. an ungranted permission after first deploy, or a
 * stale server-action reference after a redeploy) into a readable card.
 */
export default function EvaluationsError({
  ...
  useEffect(() => {
    console.error("evaluations segment error", error);
  }, [error]);
